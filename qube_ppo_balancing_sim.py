...
if __name__=="__main__":
    env = QubeBeginUprightEnv(use_simulator=True)    
    env.seed(500)
    ...
    for iteration in range(1,15000):
        ...
        if iteration % 50 == 0:
            plt.savefig('/home/ctrllab/19_urp/code_test/qube_simul/result_img/bal_sim_ppo_img'+str(iteration)+'.png')
            
            with open('/home/ctrllab/19_urp/code_test/qube_simul/result_data/bal_sim_ppo_result_reward_'+str(iteration)+'.pickle','wb') as savedata:
